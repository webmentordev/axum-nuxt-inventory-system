        ...
        <div class="p-2 sm:p-3 flex flex-col flex-1">
            ...
            <div class="mt-auto pt-3 flex items-center justify-between">
                <div class="font-bold text-sm sm:text-lg">
                    ...
                    <span class="text-xs sm:text-sm text-gray-500" v-if="product.product_type == 'solar'">/{{
                        product.per_watt_price }} W</span>
                </div>
                <span class="text-[10px] sm:text-xs px-2 py-1 rounded-full absolute top-1 right-1" :class="product.in_stock
