<template>
    <section class="h-full w-full p-6">
        ...
        <div class="w-full border border-dark-300 rounded-lg overflow-visible bg-dark-100">
            <table v-if="categories.length" class="w-full text-sm">
            ...
            <div v-else class="flex flex-col items-center justify-center py-16 px-4">
                <p class="text-zinc-300 font-semibold">No categories</p>
                <p class="text-zinc-500 text-sm mt-1">Categories you add will show up here.</p>
            </div>
        </div>
